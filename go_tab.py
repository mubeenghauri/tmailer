...
class GoTab(tk.Frame):
    def __init__(self, master, config):
        ...
        self.label5 = tk.Label(self.config_frame, text="Subject Line: ")
        self.label5v = tk.Label(self.config_frame, text=self.config.subject_line)
        self.label5.grid(row=5, column=1)
        self.label5v.grid(row=5, column=2)
        print("[Subject Line] {}".format(self.config.subject_line))
    ...
    def init(self):
        ...
        print(ConfigDialog(self, config=config))
